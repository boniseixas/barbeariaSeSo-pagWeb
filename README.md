...
<ol>
   <h4><li>1. Primeiro curso: Crie uma página da Web</li></h4>
      <ol>
         <li>1.1. Marcação do primeiro texto;</li>
         <li>1.2. Separando o conteúdo e informações;</li>
         <li>1.3. Trabalhando com CSS;</li>
         <li>1.4. Estilizando imagens;</li>
         <li>1.5. Listas de divisões de conteúdo; e</li>
         <li>1.6. Finalizando a página.</li>
      </ol>
</ol>
...
#### 1.5. Listas de divisões de conteúdo
**Conhecimentos adquiridos nesta etapa:**
...
+ Entender a diferença entre inline e block; e
...
+ Revisão da base de uma página HTML; e
...
+ Como deixar o texto em negrito com CSS; e
+ Como remover a decoração do texto.

#### 2.3. Posicionamento dos elementos
**Conhecimentos adquiridos nesta etapa:**
+ Como remover os estilos que o navegador cria automaticamente;
+ Como funciona os posicionamentos **static**, **relative** e **absolute** dos elementos; e
...
+ A mudar a cor do texto e/ou da borda de um elemento, quando o usuário passar o cursor sobre o mesmo; e
...
+ Com CSS, podemos colocar uma imagem de fundo em um elemento:
...
+ Entender a hierarquia no CSS; e
...
+ Revisão do conteúdo aprendido no treinamento anterior;
+ Introdução ao projeto do treinamento;
+ Criação da página de contato; e
...
+ Criação etiqueta para o input, com a **tag label**;
...
+ Como funciona a hierarquia no CSS; e
...
+ Como estruturar melhor o nosso código com fieldset e legend; e
